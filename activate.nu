...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Amala princy\Bank_management_system\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Amala princy\Bank_management_system\venv\Scripts\deactivate.nu'
